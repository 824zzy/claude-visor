...
private let logger = Logger(subsystem: "com.claudevisor", category: "AgentFileWatcher")
...
class AgentFileWatcher {
    ...
    private let queue = DispatchQueue(label: "com.claudevisor.agentfilewatcher", qos: .userInitiated)
